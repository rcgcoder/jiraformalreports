((function() {
    var oauthParameters = function() {
        ...
        self.parameters = {
            ...
            url: ko.observable("https://paega2.atlassian.net/wiki/rest/api/content/1051263121"),
            consumerKey: ko.observable("OauthKey"),
            consumerSecret: ko.observable(""),
            token: ko.observable("asfFgx4OZZAqAQsLBL4bTnjOq91P1NDE"),
            tokenSecret: ko.observable("H21LT5mQiTDpZKQRdJhxC4mudAfkdPJx"),
            nonce: ko.observable("8302830"),
            timestamp: ko.observable("1548825765"),
