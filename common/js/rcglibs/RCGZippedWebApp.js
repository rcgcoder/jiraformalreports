...
//			 element.src=
			 window.location="https://github.com/login/oauth/authorize?client_id=rcgcoder&redirect_uri=https://cdn.rawgit.com/rcgcoder/jiraformalreports/"+self.lastCommit+"/common/jfrWebDeploy.html";
		     return;
		  }
		  if (this.status == 302) {
